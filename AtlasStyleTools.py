...
#
# Sets the ATLAS style for pyroot and gives access to a few helpful functions 
# for making legends and putting text on plots
#
############################

from ROOT import TStyle,gROOT,TLatex,TLine
...
def ATLASLabel(x, y, offset, tcolor, tsize, text):
    l = TLatex()
    l.SetNDC()
    l.SetTextFont(62)
...
def myMarkerText(x, y, mcolor, mstyle, msize, moffset, tsize, text):
    l = TLatex()
    l.SetTextAlign(12)
    l.SetTextSize(tsize/2.5)
    l.SetNDC()
    ...
    marker = TMarker(x-moffset,y,mstyle)
    marker.SetNDC()
